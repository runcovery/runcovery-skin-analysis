...
async def scan(image: UploadFile = File(...)):
    ...
    Returns:
    - indices: Dict of relative feature-intensity indices [0, 100]
    - condition_scores: Dict of relative condition scores [0, 100], higher is better
    ...
    try:
        ...
        logger.info(f"Scan complete. Condition scores: {result['condition_scores']}")
